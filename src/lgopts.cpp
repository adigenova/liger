/*
  ...
  /Users/adigenova/miniconda2/bin/gengetopt --input=liger.ggo --include-getopt -F lgopts --no-handle-error 
...
const char *gengetopt_args_info_purpose = "Liger use the Synthetic Scaffoding Graph to compute overlap among long reads, \norder and orient short contigs, validate scaffols sequences, fill the gaps and\npolishing of the assembly.\nBy Alex Di Genova <digenova@gmail.com>";

const char *gengetopt_args_info_usage = "Usage: Liger [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -c, --contigs=STRING        Fasta file",
  "  -l, --longreads=STRING      Fasta file of long reads",
  "  -s, --samlist=STRING        List of synthetic libraries (SAM files)",
  "  -p, --prefix=STRING         Prefix for output files",
  "  -t, --cpu=INT               Number of thread to use  (default=`1')",
  "  -d, --ccoverage=STRING      File coverage for each contig",
  ...
  "\nSequence Polisher options:",
  "  -m, --minimizer_size=INT    Minimizer size  (default=`17')",
  "  -w, --minimizer_window=INT  Minimizer window  (default=`5')",
  "  -f, --minimizer_freq=INT    Max minimizer frequency  (default=`1000')",
    0
};
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->contigs_given = 0 ;
  args_info->longreads_given = 0 ;
  args_info->samlist_given = 0 ;
  ...
  args_info->minimizer_window_given = 0 ;
  args_info->minimizer_freq_given = 0 ;
}
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->contigs_arg = NULL;
  args_info->contigs_orig = NULL;
  args_info->longreads_arg = NULL;
  args_info->longreads_orig = NULL;
  args_info->samlist_arg = NULL;
  args_info->samlist_orig = NULL;
  args_info->prefix_arg = NULL;
  args_info->prefix_orig = NULL;
  args_info->cpu_arg = 1;
  args_info->cpu_orig = NULL;
  args_info->ccoverage_arg = NULL;
  args_info->ccoverage_orig = NULL;
  args_info->mcl_arg = 500;
  ...
  args_info->mlp_orig = NULL;
  args_info->minimizer_size_arg = 17;
  args_info->minimizer_size_orig = NULL;
  args_info->minimizer_window_arg = 5;
  args_info->minimizer_window_orig = NULL;
  args_info->minimizer_freq_arg = 1000;
  args_info->minimizer_freq_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->contigs_help = gengetopt_args_info_help[2] ;
  args_info->longreads_help = gengetopt_args_info_help[3] ;
  args_info->samlist_help = gengetopt_args_info_help[4] ;
  args_info->prefix_help = gengetopt_args_info_help[5] ;
  args_info->cpu_help = gengetopt_args_info_help[6] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->contigs_arg));
  free_string_field (&(args_info->contigs_orig));
  free_string_field (&(args_info->longreads_arg));
  free_string_field (&(args_info->longreads_orig));
  free_string_field (&(args_info->samlist_arg));
  free_string_field (&(args_info->samlist_orig));
  free_string_field (&(args_info->prefix_arg));
  free_string_field (&(args_info->prefix_orig));
  free_string_field (&(args_info->cpu_orig));
  free_string_field (&(args_info->ccoverage_arg));
  ...
  free_string_field (&(args_info->minimizer_window_orig));
  free_string_field (&(args_info->minimizer_freq_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->contigs_given)
    write_into_file(outfile, "contigs", args_info->contigs_orig, 0);
  if (args_info->longreads_given)
    write_into_file(outfile, "longreads", args_info->longreads_orig, 0);
  if (args_info->samlist_given)
    write_into_file(outfile, "samlist", args_info->samlist_orig, 0);
  ...
  if (args_info->ccoverage_given)
    write_into_file(outfile, "ccoverage", args_info->ccoverage_orig, 0);
  if (args_info->mcl_given)
  ...
  if (args_info->mlp_given)
    write_into_file(outfile, "mlp", args_info->mlp_orig, 0);
  if (args_info->minimizer_size_given)
    write_into_file(outfile, "minimizer_size", args_info->minimizer_size_orig, 0);
  if (args_info->minimizer_window_given)
    write_into_file(outfile, "minimizer_window", args_info->minimizer_window_orig, 0);
  if (args_info->minimizer_freq_given)
    write_into_file(outfile, "minimizer_freq", args_info->minimizer_freq_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->contigs_given)
    {
      fprintf (stderr, "%s: '--contigs' ('-c') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->longreads_given)
    {
      fprintf (stderr, "%s: '--longreads' ('-l') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->samlist_given)
    {
      fprintf (stderr, "%s: '--samlist' ('-s') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->prefix_given)
    {
      fprintf (stderr, "%s: '--prefix' ('-p') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "minimizer_window",	1, NULL, 'w' },
        { "minimizer_freq",	1, NULL, 'f' },
        { 0,  0, 0, 0 }
      };
      ...
      c = custom_getopt_long (argc, argv, "hVc:l:s:p:t:d:m:w:f:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'c':	/* Fasta file.  */
          ...
          if (update_arg( (void *)&(args_info->contigs_arg), 
               &(args_info->contigs_orig), &(args_info->contigs_given),
              &(local_args_info.contigs_given), optarg, 0, 0, ARG_STRING,
          ...
          break;
        case 'l':	/* Fasta file of long reads.  */
        
        
          if (update_arg( (void *)&(args_info->longreads_arg), 
               &(args_info->longreads_orig), &(args_info->longreads_given),
              &(local_args_info.longreads_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "longreads", 'l',
              additional_error))
            goto failure;
          ...
          break;
        case 's':	/* List of synthetic libraries (SAM files).  */
        
        
          if (update_arg( (void *)&(args_info->samlist_arg), 
               &(args_info->samlist_orig), &(args_info->samlist_given),
              &(local_args_info.samlist_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "samlist", 's',
              additional_error))
            goto failure;
        ...
        case 'p':	/* Prefix for output files.  */
          ...
          break;
        case 't':	/* Number of thread to use.  */
        
        
          if (update_arg( (void *)&(args_info->cpu_arg), 
               &(args_info->cpu_orig), &(args_info->cpu_given),
              &(local_args_info.cpu_given), optarg, 0, "1", ARG_INT,
              check_ambiguity, override, 0, 0,
              "cpu", 't',
              additional_error))
            goto failure;
          ...
          break;
        case 'd':	/* File coverage for each contig.  */
        
        
          if (update_arg( (void *)&(args_info->ccoverage_arg), 
               &(args_info->ccoverage_orig), &(args_info->ccoverage_given),
              &(local_args_info.ccoverage_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "ccoverage", 'd',
              additional_error))
            goto failure;
          ...
          break;
        case 'm':	/* Minimizer size.  */
        
        
          if (update_arg( (void *)&(args_info->minimizer_size_arg), 
               &(args_info->minimizer_size_orig), &(args_info->minimizer_size_given),
              &(local_args_info.minimizer_size_given), optarg, 0, "17", ARG_INT,
              check_ambiguity, override, 0, 0,
              "minimizer_size", 'm',
              additional_error))
            goto failure;
          ...
          break;
        case 'w':	/* Minimizer window.  */
        
        
          if (update_arg( (void *)&(args_info->minimizer_window_arg), 
               &(args_info->minimizer_window_orig), &(args_info->minimizer_window_given),
              &(local_args_info.minimizer_window_given), optarg, 0, "5", ARG_INT,
              check_ambiguity, override, 0, 0,
              "minimizer_window", 'w',
              additional_error))
            goto failure;
          ...
          break;
        case 'f':	/* Max minimizer frequency.  */
        
        
          if (update_arg( (void *)&(args_info->minimizer_freq_arg), 
               &(args_info->minimizer_freq_orig), &(args_info->minimizer_freq_given),
              &(local_args_info.minimizer_freq_given), optarg, 0, "1000", ARG_INT,
              check_ambiguity, override, 0, 0,
              "minimizer_freq", 'f',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "mcl") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->mcl_arg), 
                 &(args_info->mcl_orig), &(args_info->mcl_given),
                &(local_args_info.mcl_given), optarg, 0, "500", ARG_INT,
                check_ambiguity, override, 0, 0,
                "mcl", '-',
                additional_error))
              goto failure;
          ...
          /* Minimum contig length in scaffolding.  */
          else if (strcmp (long_options[option_index].name, "mcs") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->mcs_arg), 
                 &(args_info->mcs_orig), &(args_info->mcs_given),
                &(local_args_info.mcs_given), optarg, 0, "2000", ARG_INT,
                check_ambiguity, override, 0, 0,
                "mcs", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "rcn") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->rcn_arg), 
                 &(args_info->rcn_orig), &(args_info->rcn_given),
          ...
          /* Length of long mate-edges.  */
          else if (strcmp (long_options[option_index].name, "lme") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->lme_arg), 
                 &(args_info->lme_orig), &(args_info->lme_given),
          ...
          /* Number of long-read needed to keep a potencial erroneus mate-edge.  */
          else if (strcmp (long_options[option_index].name, "nlm") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->nlm_arg), 
                 &(args_info->nlm_orig), &(args_info->nlm_given),
                &(local_args_info.nlm_given), optarg, 0, "5", ARG_INT,
                check_ambiguity, override, 0, 0,
                "nlm", '-',
                additional_error))
              goto failure;
          ...
          /* Minimum length of reduced paths to convert them to physical fragments.  */
          else if (strcmp (long_options[option_index].name, "mlp") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->mlp_arg), 
                 &(args_info->mlp_orig), &(args_info->mlp_given),
                &(local_args_info.mlp_given), optarg, 0, "20000", ARG_INT,
                check_ambiguity, override, 0, 0,
                "mlp", '-',
                additional_error))
              goto failure;
